...
import cedarsImg from '../assets/cedars.png';
...
export const FEATURED_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: "ML pipeline estimating order completion based on session behavior and promotions. Feature engineering and model tuning within a competitive data science environment.",
    tags: ["Python", "Machine Learning", "Feature Engineering", "EDA"],
    image: headerImg,
    github: "https://github.com/tibu345/AUC-hunters",
  ...
  {
    title: "ISTIDLAL",
    description: "Educational platform for science and tech discovery. Transforms curated YouTube content into structured topic exploration with deterministic learning paths for students.",
    tags: ["Next.js", "TypeScript", "Prisma", "SQLite"],
    image: istidlalImg,
    github: "https://github.com/tibu345/ISTIDLAL",
    impact: "Design a topic-first experience with curated collections and deterministic learning paths."
  },
  {
    title: "Simple Mini-Kernel Simulator",
    description: "Kernel simulator modeling process management, CPU scheduling, and memory behavior. features a teaching-oriented CLI and GUI for visualizing OS internals.",
  ...
  {
    title: "SAM-Libraries",
    description: "Database-driven management platform for inventory and transactions. Uses FastAPI and Angular to provide a responsive administrative interface for large-scale cataloging.",
  ...
  {
    title: "961-STORE",
    description: "Collaborative e-commerce platform focused on smooth user flows and iterative delivery. Supported end-to-end shopping workflows and improved usability in team settings.",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      ...
      "Focused coursework in Machine Learning covering predictive modeling, classification, and neural network fundamentals.",
      "Hands-on Mobile Robotics experience including autonomous navigation, kinematic modeling, and LIDAR/sensor integration.",
      "Comprehensive studies in Systems Design, Hardware Architecture, and VHDL/Assembly programming."
    ],
    type: "education"
  },
  {
...
export const STRENGTHS: Strength[] = [
  ...
  },
  {
    ...
    description: "Experienced in leading technical clubs and academic initiatives, fostering a culture of collaboration and precision.",
    points: ["Leadership", "Project management", "IEEE AI Club", "Initiative"]
  }
];
