...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <section id="featured-projects" className="pt-32 pb-32 overflow-hidden bg-black relative">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="flex flex-col items-center text-center pt-12 mb-16 gap-8"
          >
            <div>
          ...
          >
            {STRENGTHS.map((strength, i) => (
              <motion.div
                key={i}
                variants={itemVariants}
                className="glass p-12 rounded-[3rem] border-white/5 active:scale-[0.98] transition-transform duration-300"
              >
