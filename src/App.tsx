...
export default function App() {
  ...
  return (
    <motion.div 
      ...
      className="relative min-h-screen bg-black text-foreground selection:bg-primary selection:text-background overflow-x-hidden"
    >
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            <div className="flex justify-center mb-8">
              <div className="px-4 py-1.5 border border-primary/20 text-primary bg-primary/5 backdrop-blur-md rounded-full text-[9px] md:text-[10px] font-bold uppercase tracking-widest flex items-center gap-2">
            ...
            <div className="relative inline-block mb-10">
              <motion.div
                ...
                className="absolute -top-10 md:-top-16 -left-10 md:-left-20 text-[60px] md:text-[140px] font-editorial text-white/[0.03] pointer-events-none select-none tracking-tighter"
              >
                COMPUTER
              </motion.div>
              <h1 className="text-5xl sm:text-6xl md:text-[8rem] lg:text-[10rem] font-display font-bold tracking-tighter leading-[0.85] relative z-10 text-glow">
                Sami Harb <br />
                <span className="text-primary italic font-serif text-[0.7em]">Engineering</span>
              </h1>
            </div>
            
            <p className="max-w-xl mx-auto text-base md:text-xl text-muted-foreground mb-12 leading-relaxed font-light px-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 mb-24">
              <a href="#featured-projects" className="w-full sm:w-auto inline-flex items-center justify-center rounded-full px-10 h-14 font-bold bg-primary text-black hover:bg-white transition-all duration-500 group shadow-lg shadow-primary/10 tracking-widest text-xs">
                EXPLORE WORK
                <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" size={18} />
              </a>
              <a 
                href="#contact" 
                className="w-full sm:w-auto inline-flex items-center justify-center rounded-full px-10 h-14 font-bold border border-white/10 glass hover:bg-white/10 transition-all duration-500 tracking-widest text-xs"
              >
                LET'S TALK
              </a>
            </div>
      ...
      <section id="about" className="py-32 relative overflow-hidden bg-zinc-950">
        {/* Ghost transition from Hero */}
        <div className="absolute top-[-1px] left-0 w-full h-40 bg-gradient-to-b from-black to-transparent pointer-events-none z-20" />
      ...
      <section id="skills" className="py-20 md:py-32 bg-black relative overflow-hidden">
        {/* Ghost transition from About */}
        <div className="absolute top-[-1px] left-0 w-full h-40 bg-gradient-to-b from-zinc-950 to-transparent pointer-events-none z-20" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-7xl font-display font-bold mb-6 tracking-tight">Technical Arsenal</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto font-light leading-relaxed text-sm md:text-base">
      ...
      <section id="featured-projects" className="py-20 md:py-32 overflow-hidden bg-zinc-950 relative">
        {/* Ghost transition from Skills */}
        <div className="absolute top-[-1px] left-0 w-full h-40 bg-gradient-to-b from-black to-transparent pointer-events-none z-20" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="flex flex-col items-center text-center pt-8 md:pt-12 mb-12 md:mb-16 gap-8"
          >
            <div>
              <span className="text-primary font-serif italic text-xs uppercase tracking-[0.4em] font-bold mb-6 block">Selected Work</span>
              <h2 className="text-3xl sm:text-4xl md:text-7xl font-display font-bold leading-[1.1]">Featured Projects</h2>
            </div>
          </motion.div>

          <div className="relative group/slider max-w-7xl mx-auto px-0 md:px-0">
            {/* Slider container with visible overflow for arrows on desktop */}
            <div className="relative">
              {/* Navigation Arrows - Hidden on small mobile to avoid layout issues */}
              <button 
                onClick={prevProject}
                disabled={currentProjectIndex === 0}
                className="hidden lg:flex absolute -left-20 top-1/2 -translate-y-1/2 z-30 items-center justify-center text-white/50 hover:text-primary transition-all disabled:opacity-0 disabled:pointer-events-none group/btn"
              ...
              <button 
                ...
                className="hidden lg:flex absolute -right-20 top-1/2 -translate-y-1/2 z-30 items-center justify-center text-white/50 hover:text-primary transition-all disabled:opacity-0 disabled:pointer-events-none group/btn"
          ...
          {/* Slider Progress Indicator & Mobile Controls */}
          <div className="mt-12 flex flex-col items-center gap-8">
            ...
            <div className="flex lg:hidden items-center gap-6">
              <button 
                onClick={prevProject}
                disabled={currentProjectIndex === 0}
                className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:text-primary disabled:opacity-20 transition-all"
              >
                <ArrowLeft size={20} />
              </button>
              <button 
      ...
      <section id="other-projects" className="py-20 md:py-32 bg-black relative overflow-hidden">
        {/* Ghost transition from Featured */}
        <div className="absolute top-[-1px] left-0 w-full h-40 bg-gradient-to-b from-zinc-950 to-transparent pointer-events-none z-20" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-7xl font-display font-bold mb-6">Other Projects</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto font-light leading-relaxed text-sm md:text-base">
      ...
      {/* Experience Section */}
      <section id="experience" className="py-20 md:py-32 bg-zinc-950 relative overflow-hidden">
        {/* Ghost transition from Other Projects */}
        <div className="absolute top-[-1px] left-0 w-full h-40 bg-gradient-to-b from-black to-transparent pointer-events-none z-20" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          <motion.div 
            ...
            className="text-center mb-16 md:mb-20"
          >
            <span className="text-primary font-serif italic text-xs uppercase tracking-[0.4em] font-bold mb-6 block">Roadmap</span>
            <h2 className="text-3xl sm:text-4xl md:text-7xl font-display font-bold mb-6">The Journey</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto font-light leading-relaxed text-sm md:text-base">
      ...
      {/* Languages Section */}
      <section id="languages" className="py-20 md:py-32 bg-black relative overflow-hidden">
        {/* Ghost transition from Experience */}
        <div className="absolute top-[-1px] left-0 w-full h-40 bg-gradient-to-b from-zinc-950 to-transparent pointer-events-none z-20" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-7xl font-display font-bold mb-6">Languages</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto font-light leading-relaxed text-sm md:text-base">
            ...
            {LANGUAGES.map((lang, i) => (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-base md:text-xl font-display font-bold">{lang.name}</h3>
                  <span className="px-3 py-1 rounded-full border border-primary/20 bg-primary/20 text-primary text-[8px] md:text-[9px] font-bold uppercase tracking-widest">{lang.level}</span>
                </div>
                <p className="text-xs md:text-sm text-muted-foreground mb-6">{lang.proficiency}</p>
      ...
      {/* Strengths Section */}
      <section id="strengths" className="py-20 md:py-32 bg-zinc-950 relative overflow-hidden">
        {/* Ghost transition from Languages */}
        <div className="absolute top-[-1px] left-0 w-full h-40 bg-gradient-to-b from-black to-transparent pointer-events-none z-20" />
        
        <div className="absolute top-[40%] right-[-10%] w-[40%] h-[40%] bg-primary/5 rounded-full blur-[140px] pointer-events-none" />
        <div className="container mx-auto px-6 relative z-10">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h2 className="text-3xl sm:text-5xl md:text-[6rem] font-display font-bold mb-8 tracking-tighter leading-none">The <span className="text-white">Core</span> Strength</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto font-light leading-relaxed text-base md:text-lg">
          ...
          <motion.div 
            ...
            whileInView="visible"
            viewport={{ once: true, margin: "-100px" }}
            className="grid md:grid-cols-2 gap-6 md:gap-12 max-w-6xl mx-auto"
          >
            {STRENGTHS.map((strength, i) => (
              <motion.div
                key={i}
                variants={itemVariants}
                className="glass p-8 md:p-12 rounded-3xl md:rounded-[3rem] border-white/5 active:scale-[0.98] transition-transform duration-300"
              >
                <div className="flex items-center gap-4 mb-8">
                  <div className="w-10 md:w-12 h-[1px] bg-primary/30" />
                  <h3 className="text-2xl md:text-3xl font-display font-bold text-white">{strength.title}</h3>
                </div>
                <p className="text-muted-foreground/80 mb-10 leading-relaxed font-light text-sm md:text-lg">{strength.description}</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {strength.points.map((point, j) => (
                    <div key={j} className="flex items-center gap-3 text-[10px] md:text-[11px] font-bold uppercase tracking-widest text-white/60 hover:text-primary transition-colors duration-300">
                      <div className="w-1.5 h-1.5 rounded-full bg-primary shadow-[0_0_8px_rgba(0,242,255,0.4)]" />
                      {point}
                    </div>
                  ))}
                </div>
      ...
      <section id="services" className="py-20 md:py-32 bg-black relative overflow-hidden">
        {/* Ghost transition from Strengths */}
        <div className="absolute top-[-1px] left-0 w-full h-40 bg-gradient-to-b from-zinc-950 to-transparent pointer-events-none z-20" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-7xl font-display font-bold mb-6 tracking-tight">Services</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto font-light leading-relaxed text-sm md:text-base">
          ...
          >
            {SERVICES.map((service, i) => (
              <div
                key={i}
                className="glass p-6 md:p-8 rounded-3xl text-center flex flex-col items-center"
              >
                <div className="w-12 h-12 md:w-16 md:h-16 mb-6 rounded-2xl bg-primary/10 flex items-center justify-center text-primary">
                  <service.icon size={28} />
                </div>
                <h3 className="text-lg md:text-xl font-display font-bold mb-4">{service.title}</h3>
