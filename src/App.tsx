...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <section id="featured-projects" className="py-32 overflow-hidden bg-black relative">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div className="flex gap-4 sm:gap-6 ml-auto lg:ml-0">
              <button 
                onClick={prevProject}
                disabled={currentProjectIndex === 0}
                className="w-14 h-14 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/5 hover:border-primary/50 text-white transition-all disabled:opacity-20 disabled:cursor-not-allowed group shadow-lg"
              >
